...
public class SecurityConfig {
    ...
    public SecurityFilterChain uiChain(final HttpSecurity http) throws Exception {
        http
                ...
                .formLogin(form -> form
                        ...
                        .successHandler(successHandler) //replace .defaultSuccessUrl("/study-rooms", true): for students entering in the selections of study rooms
    ...
    private final RoleBasedLoginSuccessHandler successHandler; //adding the constructor for the right login
